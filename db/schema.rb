...
ActiveRecord::Schema.define(version: 20161104132554) do
  ...
  create_table "clients", force: :cascade do |t|
    ...
    t.datetime "created_at",           null: false
    t.datetime "updated_at",           null: false
    t.index ["account_executive_id"], name: "index_clients_on_account_executive_id", using: :btree
  end
  ...
  add_foreign_key "clients", "account_executives"
end
